...
namespace WirelessTeleporter
{
    class ServerInfoUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            Texture2D buttonDeleteTexture = ModLoader.GetTexture("WirelessTeleporter/UI/BtnClose");
            UIHoverImageButton closeButton = new UIHoverImageButton(buttonDeleteTexture, "Close"); // Localized text for "Close"
